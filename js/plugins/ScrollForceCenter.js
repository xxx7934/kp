...
(function() {
    ...
    Game_Interpreter.prototype.pluginCommandScrollForceCenter = function(command) {
        switch (getCommandName(command)) {
            ...
            case '_ENABLE_RESERVE':
                ...
                break;
			case '_REM_ENABLE':
				$gameParty.setMapForceCenter(true);
				break;
			case '_REM_DISABLE':
				$gameParty.setMapForceCenter(false);
				break;
        }
    };
	...
	Game_Party.prototype.setMapForceCenter = function(value) {
        this._mapForceCenter = value;
    };
	Game_Party.prototype.isMapForceCenter = function() {
        return this._mapForceCenter;
    };
    ...
    Game_Map.prototype.isForceCenterVertical = function() {
        return !this.isLoopVertical() && (this.isForceCenter() || $gameParty.isMapForceCenter());
    };

    Game_Map.prototype.isForceCenterHorizontal = function() {
        return !this.isLoopHorizontal() && (this.isForceCenter() || $gameParty.isMapForceCenter());
    };
