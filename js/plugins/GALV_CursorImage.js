...
Window_Selectable.prototype.createGalvCursor = function() {
	if(TESTING_DISABLE_GALV_CURSOR) return;
	this._galvCursor = new Sprite_GalvCursor();
	this._galvCursor.setup(this);
	this.addChild(this._galvCursor);
};

Window_BattleEnemy.prototype.createGalvCursor = function() { return; };
Window_NameInput.prototype.createGalvCursor = function() { return; };
Window_NumberInput.prototype.createGalvCursor = function() { return; };
Window_ShopNumber.prototype.createGalvCursor = function() { return; };
Window_BattleStatus.prototype.createGalvCursor = function() { return; };
Window_ActorCommand.prototype.createGalvCursor = function() { return; };
Window_BattleLog.prototype.createGalvCursor = function() { return; };
Window_MenuStatus.prototype.createGalvCursor = function() { return; };
Window_TitleCommand.prototype.createGalvCursor = function() { return; };
...
Sprite_GalvCursor.prototype.initialize = function() {
    Sprite_Base.prototype.initialize.call(this);
	//this.setup(window);
};

Sprite_GalvCursor.prototype.setup = function(window) {
    this._window = window;
	this.createImage();
	this._ticker = 0;
	this._pattern = 0;
