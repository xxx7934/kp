...
var REM_LEFT_HEIGHT = 7.7;
var REM_TOP_HEIGHT = 4;
...
(function() {
    ...
    Game_Actor.prototype.payStsCost = function(cost) {
		...
		if(cost.type == 'gold') value = this.modifiedEdictGoldCost(value);
        switch (cost.type) {
            case 'item':
    ...
    Game_Actor.prototype.isPayCostNg = function(cost) {
        ...
        switch (cost.type) {
          ...
          case 'gold':
            return $gameParty.gold() < this.modifiedEdictGoldCost(value);
          case 'weapon':
    ...
    Window_StsSkillStatus.prototype.initialize = function(x, y, width, height) {
		height = this.fittingHeight(REM_TOP_HEIGHT);
        ...
        for (let i = 0; i < 3; i++) {
            ...
            if (cost) {
				...
				if(cost.type == 'sp') {
					...
					costTypes++;
					fundingCost = this._actor.modifiedEdictGoldCost(cost.value);
    ...
    Window_StsPreskill.prototype.drawPreSkills = function(x, y, width) {
        if (this._skillId && this._tTypeId) {
			...
			var selectedSkill = actor.stsSkill(this._skillId);
    ...
    Scene_STS.prototype.createTreeTypeWindow = function() {
		...
		var height = this._stsActorStatusWindow.fittingHeight(REM_LEFT_HEIGHT); //height
