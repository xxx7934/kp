...
ConfigManager.wasdMap = {
  9: 'tab', 13: 'ok', 16: 'shift', 17: 'control', 18: 'alt', 27: 'escape',
  32: 'ok', 33: 'pageup', 34: 'pagedown', 37: 'left', 38: 'up', 39: 'right',
  40: 'down', 87: 'up', 65: 'left', 83: 'down', 68: 'right', 74: 'ok',
  75: 'escape', 77: 'menu', 45: 'escape', 85: 'pageup', 73: 'pagedown', 
...
Window_KeyConfig.prototype.makeCommandList = function(index) {
		...
		this.addCommand(TextManager.yanflyKeyboardDefaultLayoutText, 'default', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'default', true);
		this.addCommand(TextManager.yanflyKeyboardWASDText, 'wasd', true);
		for (var i = 0; i < 6; ++i) this.addCommand(' ', 'wasd', true);
		this.addCommand(TextManager.yanflyKeyboardFinishConfigText, 'cancel', true);
...
Window_KeyConfig.prototype.actionKey = function(action) {
		switch(action) {
		case 'ok':
			return TextManager.yanflyKeyboardOKKey;
			break;
		case 'escape':
			return TextManager.yanflyKeyboardEscapeKey;
			break;
		case 'cancel':
			return TextManager.yanflyKeyboardCancelKey;
			break;
		case 'menu':
			return TextManager.yanflyKeyboardMenuKey;
			break;
		case 'shift':
			return TextManager.yanflyKeyboardShiftKey;
			break;
		case 'pageup':
			return TextManager.yanflyKeyboardPageUpKey;
			break;
		case 'pagedown':
			return TextManager.yanflyKeyboardPageDownKey;
			break;
		case 'left':
			return TextManager.yanflyKeyboardLeftKey;
			break;
		case 'up':
			return TextManager.yanflyKeyboardUpKey;
			break;
		case 'right':
			return TextManager.yanflyKeyboardRightKey;
			break;
		case 'down':
			return TextManager.yanflyKeyboardDownKey;
			break;
    default:
      if (Imported.YEP_ButtonCommonEvents) {
...
Window_KeyConfig.prototype.updateHelp = function() {
    if (!this._helpWindow) return;
		...
		case 'key':
			this._helpWindow.setText(TextManager.yanflyKeyboardHelp);
			break;
		case 'default':
			this._helpWindow.setText(TextManager.yanflyKeyboardDefaultLayoutHelp);
			break;
		case 'wasd':
			this._helpWindow.setText(TextManager.yanflyKeyboardWASDHelp);
			break;
		case 'cancel':
			this._helpWindow.setText(TextManager.yanflyKeyboardFinishConfigHelp);
			break;
		default:
...
Window_KeyAction.prototype.makeCommandList = function() {
	this.addCommand(TextManager.yanflyKeyboardClearText, 'ok', true, 'clear');
	this.addCommand(TextManager.yanflyKeyboardOKText, 'ok', true, 'ok');
	this.addCommand(TextManager.yanflyKeyboardEscapeText, 'ok', true, 'escape');
	this.addCommand(TextManager.yanflyKeyboardCancelText, 'ok', true, 'cancel');
	this.addCommand(TextManager.yanflyKeyboardMenuText, 'ok', true, 'menu');
	this.addCommand(TextManager.yanflyKeyboardShiftText, 'ok', true, 'shift');
	this.addCommand(TextManager.yanflyKeyboardPageUpText, 'ok', true, 'pageup');
	this.addCommand(TextManager.yanflyKeyboardPageDownText, 'ok', true, 'pagedown');
	this.addCommand(TextManager.yanflyKeyboardLeftText, 'ok', true, 'left');
	this.addCommand(TextManager.yanflyKeyboardUpText, 'ok', true, 'up');
	this.addCommand(TextManager.yanflyKeyboardRightText, 'ok', true, 'right');
	this.addCommand(TextManager.yanflyKeyboardDownText, 'ok', true, 'down');
